...
var wpAjaxUrl='http://localhost/new_wordpress/wp-admin/admin-ajax.php';var flBuilderUrl='http://localhost/new_wordpress/wp-content/plugins/beaver-builder-lite-version/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://localhost/new_wordpress/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://localhost/new_wordpress/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
