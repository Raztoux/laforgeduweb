	...
	<footer id="colophon" class="site-footer">
		<div class="mainFooter">
			...
			<div class="site-copy-down">
				<div class="site-info">
					<p>
						Copyright © 20187 agence web La Forge du Web – <a href="http://la-forge-du-web.copyright01.com/">N° de dépôt Z1SE46</a> -  <a href="<?php echo get_privacy_policy_url(); ?>">Mention Légale</a>
					</p>
				</div><!-- .site-info -->
