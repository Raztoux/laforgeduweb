...
if( ! function_exists('freddo_show_social_network')){
	function freddo_show_social_network($position) {
		...
		<div class="<?php echo $position == 'float' ? 'site-social-float' : 'site-social-footer' ?>">
			...
			<?php endif; ?>
			<?php if ($imdbURL) : ?>
				<a class="freddo-social" href="<?php echo esc_url($imdbURL); ?>" target="<?php echo esc_attr($openLinks); ?>" title="<?php esc_attr_e( 'Imdb', 'freddo' ); ?>"><i class="fa fa-imdb spaceLeftRight"><span class="screen-reader-text"><?php esc_html_e( 'Imdb', 'freddo' ); ?></span></i></a>
			<?php endif; ?>
		</div>
		<?php
	}
