	...
	<div class="freddo_action_features">
		...
		<div class="features_columns">
			...
			<div class="four features_columns_single">
				<?php $doc_price_1 = get_field('plaquette_prix_1'); ?>
				<?php $doc_price_2 = get_field('plaquette_prix_2'); ?>
				<?php $doc_price_3 = get_field('plaquette_prix_3'); ?>
				<?php if($fontAwesomeIcon1): ?>
					<div class="featuresIcon"><i class="<?php echo esc_attr($fontAwesomeIcon1); ?>" aria-hidden="true"></i></div>
				<?php endif; ?>
				<?php if($choosePageBox1): ?>
				...
				<?php endif; ?>
				<?php if($textButton1 || is_customize_preview()): ?>
					<div class="freddoButton features"><a href="<?php echo ($doc_price_1) ? esc_url($doc_price_1): esc_url($linkButton1); ?>"><?php echo esc_html($textButton1); ?></a></div>
				<?php endif; ?>
			</div>
			<div class="four features_columns_single">
				<?php if($fontAwesomeIcon2): ?>
				...
				<?php endif; ?>
				<?php if($textButton2 || is_customize_preview()): ?>
					<div class="freddoButton features"><a href="<?php echo ($doc_price_2) ? esc_url($doc_price_2): esc_url($linkButton2); ?>"><?php echo esc_html($textButton2); ?></a></div>
				<?php endif; ?>
			</div>
			<div class="four features_columns_single">
				<?php if($fontAwesomeIcon3): ?>
				...
				<?php endif; ?>
				<?php if($textButton3 || is_customize_preview()): ?>
					<div class="freddoButton features"><a href="<?php echo ($doc_price_3) ? esc_url($doc_price_3): esc_url($linkButton3); ?>"><?php echo esc_html($textButton3); ?></a></div>
				<?php endif; ?>
			</div>
			<div class="four features_columns_single">
